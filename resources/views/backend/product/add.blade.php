                                ...
                                <div class="border border-3 p-4 rounded">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-6">
                                            ...
                                            <input type="text" class="form-control" id="inputProductTitle" placeholder="Enter unique product code" name="product_code" required>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="inputProductDescription" class="form-label">Short Description</label>
                                        <input type="text" class="form-control" name="short_description" id="" rows="3" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="inputProductDescription" class="form-label">Long Description</label>
                                        <textarea class="form-control" id="" name="long_description" rows="3" required></textarea>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="text-secondary">
                                            <input class="form-control" required type="file" name="image2" id="image2">
                                            @error('image2')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="text-secondary">
                                            <input class="form-control" required type="file" name="image4" id="image4">
                                            @error('image4')
                                            <span class="text-danger">{{$message}} </span>
                                            @enderror
                                        </div>
                                ...
                                <div class="border border-3 p-4 rounded">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="offer_price" class="form-control" id="inputCompareatprice" placeholder="00.00" required>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="brand" required class="form-control" id="inputBrand" placeholder="xxx">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="inputRating" class="form-label">Rating</label>
                                            <input type="text" name="star_rating" required class="form-control" id="inputRating" placeholder="">
                                        </div>
                                        <div class="col-12 mb-3">
                                            <label class="form-label">Product Color</label>
                                            <input type="text" name="color" required class="form-control visually-hidden align-items-center" data-role="tagsinput" value="Red,White,Black">
                                        </div>
                                        <div class="col-12 mb-3">
                                            <label class="form-label">Product Size</label>
                                            <input type="text" name="size" required class="form-control bg-facebook visually-hidden" data-role="tagsinput" value="S,M,L,XL,XXL">
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">
